...
?>
	<a class="mks-twitter-share-button" href="javascript:void(0);" data-url="http://twitter.com/intent/tweet?url=<?php echo $tweet_url; ?>&amp;text=<?php echo urlencode($tweet_text); ?>"><i class="dashicons dashicons-twitter"></i> Tweet about Voice</a>
</div>
